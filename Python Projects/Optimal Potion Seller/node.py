...
class AVLTreeNode(TreeNode, Generic[K, I]):
    ...
    def __init__(self, key: K, item: I = None) -> None:
        ...
        self.height = 1
        self.num_of_left_nodes = 0 # the total number of nodes on the left subtree of the current node
        self.num_of_right_nodes = 0 #the total number of nodes on the right subtree of the current node
